...
# 🔍 Enhanced Palindrome Checker (Pygame) - Day 9

## 📝 Description
**Enhanced Palindrome Checker** is a visually interactive **Python and Pygame** application  
that allows users to check whether a given text is a palindrome.  
It features **dark mode support**, **a history log**, and **real-time feedback**.

## 🎯 Features
✔️ **Instant palindrome check** with real-time feedback.  
✔️ **Dark mode toggle** for improved UI experience.  
✔️ **History tracking** (last 5 checks displayed).  
✔️ **Minimalist and intuitive UI.**  
